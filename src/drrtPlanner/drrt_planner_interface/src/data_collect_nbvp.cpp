...
int main(int argc, char** argv)
{
  ...
  time_volume_name = ros::package::getPath("drrt_planner_interface") + "/data/nbvp_time_volume.txt";
  time_dist_name = ros::package::getPath("drrt_planner_interface") + "/data/nbvp_time_dist.txt";
  time_plantime_name = ros::package::getPath("drrt_planner_interface") + "/data/nbvp_time_plantime.txt";
  dist_plantime_name = ros::package::getPath("drrt_planner_interface") + "/data/nbvp_dist_plantime.txt";
  time_localplan_name = ros::package::getPath("drrt_planner_interface") + "/data/nbvp_time_localplantime.txt";
  dist_localplan_name = ros::package::getPath("drrt_planner_interface") + "/data/nbvp_dist_localplantime.txt";
