...
void dsvplanner_ns::Drrt::getThreeLocalFrontierPoint()  // Three local frontiers that are most close to the last
...
bool dsvplanner_ns::Drrt::collisionCheckByTerrain(StateVec origin_point, StateVec goal_point)
