...
def generate_launch_description():
    param_dir_planning = os.path.join(get_package_share_directory('dsvp_launch'), 'config', 'exploration_matterport.yaml')
    param_dir_octomap = os.path.join(get_package_share_directory('dsvp_launch'), 'config', 'octomap_matterport.yaml')
    ...
    bag_name = LaunchConfiguration('bag_name', default='matterport')
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
              os.path.join(get_package_share_directory('graph_planner'), 'launch/graph_planner_matterport.py'
        	    )
            )
        )
    ])