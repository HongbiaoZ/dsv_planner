...
def generate_launch_description():
    param_dir_planning = os.path.join(get_package_share_directory('davp_launch'), 'config', 'exploration_forest.yaml')
    param_dir_octomap = os.path.join(get_package_share_directory('davp_launch'), 'config', 'octomap_forest.yaml')
    ...
    bag_name = LaunchConfiguration('bag_name', default='forest')
