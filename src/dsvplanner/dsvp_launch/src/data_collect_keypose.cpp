...
int pointvolume(PointCloud<PointXYZ>::Ptr cloud)
{
  ...
  boxFilter.setMin(Eigen::Vector4f(-65, -70, -20, 1.0));
...
void keyPoseAndKeyPoseCloudCallback(const nav_msgs::Odometry::ConstPtr &keypose_msg, const sensor_msgs::PointCloud2ConstPtr &keypose_cloud_msg)
{
  ...
  if(first_iteration)
  {
    ...
    time_start = keypose_cloud_msg->header.stamp;
    mapcloud->clear();
    travelDist = 0;
  ...
  {
    current_time = keypose_cloud_msg->header.stamp;
    ...
    std::cout<<keyposecloudPassFiltered->points.size()<<std::endl;
...
int main(int argc, char** argv)
{
  ...
  time_volume_name = ros::package::getPath("interface_nbvp_rotors") + "/data/time_volume.txt";
  time_dist_name = ros::package::getPath("interface_nbvp_rotors") + "/data/time_dist.txt";
  time_plantime_name = ros::package::getPath("interface_nbvp_rotors") + "/data/time_plantime.txt";
  dist_plantime_name = ros::package::getPath("interface_nbvp_rotors") + "/data/dist_plantime.txt";
  time_localplan_name = ros::package::getPath("interface_nbvp_rotors") + "/data/time_localplantime.txt";
  dist_localplan_name = ros::package::getPath("interface_nbvp_rotors") + "/data/dist_localplantime.txt";
